...
const string_base: string = "<b>Aqui esta la ayuda para el modulo:</b>";
...
export const es = {
	...
	extrasModule: {
		...
		finish: (name:string)=> `Sticker añadido satisfactoriamente [aqui](t.me/addstickers/${name})`,
	...
	ownerModule: {
		...
		sudoUpdate: (sudo:string) => `Se han actualizado loa valores de ${sudo}.`,
	...
	welcomeModule: {
		...
		prefSuccess:(a:string)=> `Preferencias de ${a=='welcome' ? 'bienvenida': 'despedida'} establecidas.`
	},
	trasnlatorModule:{
